...
<!-- Mirrored from spark.bootlab.io/ui-notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Apr 2021 05:22:20 GMT -->
								...
								<div class="card-body">
									<div class="row">
										<div class="col-xs-12 col-md-8">
											...
											<div class="form-group">
												<label class="form-label" for="toastr-duration">Duration</label>
												<select class="custom-select form-control" id="toastr-duration" name="toastr-duration">
											...
											<div class="form-group custom-controls-stacked">
												<label class="custom-control custom-checkbox">
													<input type="checkbox" class="custom-control-input" id="toastr-close" checked>
													<span class="custom-control-label">Close button</span>
												</label>
												<label class="custom-control custom-checkbox">
													<input type="checkbox" class="custom-control-input" id="toastr-progress-bar" checked>
													<span class="custom-control-label">Progress bar</span>
												</label>
												<label class="custom-control custom-checkbox">
													<input type="checkbox" class="custom-control-input" id="toastr-newest-on-top" checked>
									...
									<button class="btn btn-primary mr-1" id="toastr-show">Show notification</button>
									<button class="btn btn-default" id="toastr-clear">Clear all</button>
								</div>
							</div>
						</div>
					</div>
